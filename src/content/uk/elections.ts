...
const RESULT_2017: Record<string, RegionResult> = {
  ...
  EM:  { v: { con: 0.51, lab: 0.40, ld: 0.05 }, s: fy("2017", "EM", "con", { lab: 18 }) },
  WM:  { v: { con: 0.49, lab: 0.42, ld: 0.04 }, s: fy("2017", "WM", "con", { lab: 24 }) },
  EE:  { v: { con: 0.55, lab: 0.33, ld: 0.08 }, s: fy("2017", "EE", "con", { lab: 16, ld: 1 }) },
  LON: { v: { lab: 0.55, con: 0.33, ld: 0.09 }, s: fy("2017", "LON", "lab", { con: 21, ld: 3 }) },
  SE:  { v: { con: 0.54, lab: 0.29, ld: 0.11 }, s: fy("2017", "SE", "con", { lab: 18, ld: 3 }) },
  SW:  { v: { con: 0.51, lab: 0.29, ld: 0.15 }, s: fy("2017", "SW", "con", { lab: 13, ld: 1 }) },
...
const RESULT_1951: Record<string, RegionResult> = {
  ...
  EM:  { v: { con: 0.48, lab: 0.48, ld: 0.03, oth: 0.01 }, s: fy("1951", "EM", "lab", { con: 20 }) },
  WM:  { v: { con: 0.49, lab: 0.47, ld: 0.03, oth: 0.01 }, s: fy("1951", "WM", "lab", { con: 26 }) },
  EE:  { v: { con: 0.55, lab: 0.40, ld: 0.04, oth: 0.01 }, s: fy("1951", "EE", "con", { lab: 19 }) },
  LON: { v: { con: 0.50, lab: 0.47, ld: 0.02, oth: 0.01 }, s: fy("1951", "LON", "con", { lab: 35 }) },
  ...
  NI:  { v: { uup: 0.65, oth: 0.35 }, s: fy("1951", "NI", "uup", { oth: 4 }) },
};
